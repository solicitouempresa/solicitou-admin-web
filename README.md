...
[Demo](https://flatlogic.com/templates/solicitou-admin-web/demo) | [Download](https://github.com/flatlogic/solicitou-admin-web/archive/master.zip) | [Available versions](https://demo.flatlogic.com/solicitou-admin-web/) | [More templates](https://flatlogic.com/admin-dashboards) | [Support forum](https://flatlogic.com/forum)
...
```shell
$ git clone -o solicitou-admin-web -b master --single-branch \
      https://github.com/flatlogic/solicitou-admin-web.git MyApp
$ cd MyApp
```
